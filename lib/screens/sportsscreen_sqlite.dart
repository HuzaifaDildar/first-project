...
class SportsScreenFirebase extends StatefulWidget {
  const SportsScreenFirebase({super.key});

  @override
  State<SportsScreenFirebase> createState() => _SportsScreenFirebaseState();
}

class _SportsScreenFirebaseState extends State<SportsScreenFirebase> {
